...
//  %a_r1 = hir.memref.extract %a[port 0] :!hir.memref<(bank 2)x(bank 3)x2x4xi8> port [#reg_rd]
//  hir.call @foo(%a_r1) at %t : !hir.func<(!hir.memref<(bank 2)x(bank 3)x2x4xi8> ports [#reg_rd]) -> ()>
//  %a_r2 = hir.memref.extract %a[port 0] :!hir.memref<(bank 2)x(bank 3)x2x4xi8> port [#reg_rd]
